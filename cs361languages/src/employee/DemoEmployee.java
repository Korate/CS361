...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints "PART TIME EMPLOYEE" because emp3 is upcast to PartTimeEmployee type.
		// emp3.getHourlyRate(); // returns syntax error because can only use those override method by updasting, 
		// and Employee class do not have method getHourlyrateto to override
		...
		// because supertype can not downcasting to subtype (except the supertype is upcasting from a subtype)
